...
env.Append(
    ...
    LIBS=[
        "-lgcc", "-lwpa2", "-ldl", "-lesp-tls", "-lesp_adc_cal", "-lfb_gfx", "-ldriver", "-lc_nano", "-lapp_update", "-lfr", "-lheap", "-lespcoredump", "-llibsodium", "-lc", "-lbtdm_app", "-ltcpip_adapter", "-lesp_websocket_client", "-lface_recognition", "-lspiffs", "-lvfs", "-llwip", "-llog", "-lrtc", "-lprotobuf-c", "-lopenssl", "-ljson", "-lmicro-ecc", "-lnvs_flash", "-lwifi_provisioning", "-lesp_event", "-lfatfs", "-lsmartconfig", "-lfreemodbus", "-lesp_http_server", "-lunity", "-lxtensa-debug-module", "-lcoap", "-lethernet", "-lprotocomm", "-lface_detection", "-lbootloader_support", "-lesp_https_ota", "-lod", "-lesp_http_client", "-lpthread", "-lesp32", "-lwpa_supplicant", "-lwps", "-lnet80211", "-lmbedtls", "-lhal", "-lulp", "-lesp_ringbuf", "-lmqtt", "-ljsmn", "-lconsole", "-lesp32-camera", "-limage_util", "-lpp", "-lmesh", "-lmdns", "-lnghttp", "-lsoc", "-lsdmmc", "-lspi_flash", "-lwpa", "-lasio", "-lesp_https_server", "-lnewlib", "-lcore", "-lwear_levelling", "-lefuse", "-ltcp_transport", "-lsmartconfig_ack", "-lm", "-lphy", "-lexpat", "-lfreertos", "-lfd", "-lespnow", "-lcxx", "-lapp_trace", "-lcoexist", "-lbt", "-lstdc++"
    ],
